                ...
                <form method="POST" action="/staff/edit/{{ $staff->id }}" enctype="multipart/form-data"
                            ...
                            <a href="#" class="pointer" onclick="document.getElementById('file-upload').click()">
                                <div
                                    ...
                                    <div class="text-center">
                                        <div>
                                            <img id="avatar" class="object-cover h-[200px] rounded-lg w-[200px]"
                                ...
                                <div
                                    ...
                                    <div class="text-center">
                                        <img id="avatar" name="avatar"
                                            class="object-cover h-[200px] rounded-lg w-[200px] hidden"
                                            alt="Image Preview" style="max-width: 100%; max-height: 200px;" />
                                        <svg id="gallery-logo" class="mx-auto h-12 w-12 text-gray-300"
                                        ...
                                        <p id="file-type" class="text-xs leading-5 text-gray-600">PNG, JPG, GIF up to
                                            10MB
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div>
                        ...
                        <select name="type" id="type"
                            class="max-w-md w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm text-gray-700">
                            <option hidden value="teacher" selected>{{ ucfirst($staff->type) }}</option>
    ...
    function previewImage(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                galleryLogo.classList.add('hidden');
            };
