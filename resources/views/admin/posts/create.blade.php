    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <x-box>
                ...
                <form method="POST" action="/post" class="mt-6 space-y-3" enctype="multipart/form-data">
                    @csrf
                    <div>
                            ...
                            <div
                                ...
                                <div class="text-center">
                                    <img id="thumbnail" name="thumbnail"
                                        class="object-cover h-[300px] rounded-lg w-[700px] hidden" alt="Image Preview"
                    ...
                    <div>
                        ...
                        <x-text-input type="date" class="max-w-md w-full" name="date" id="date" />
