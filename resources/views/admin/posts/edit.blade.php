    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <x-box>
                ...
                <form method="POST" action="/post/edit/{{ $posts->id }}" class="mt-6 space-y-3" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div>
                            ...
                            <div
                                ...
                                <div class="text-center">
                                    @if (!empty($posts->thumbnail))
                                        <div class="">
                                            <img id="thumbnail-preview" src="{{ asset('storage/' . $posts->thumbnail) }}"
                                    ...
                                    @endif
                                    <input id="thumbnail" name="thumbnail" value="{{ $posts->thumbnail }}" type="file" class="sr-only hidden" onchange="previewImage(event)">
